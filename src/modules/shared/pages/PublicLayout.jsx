    ...
    <div className="min-h-screen grid grid-rows-[auto_1fr_auto] bg-gray-100 text-gray-800 overflow-hidden">
      ...
      <header className="sticky top-0 z-50 p-6 bg-white shadow-md border-b border-gray-200">
        <nav className="container mx-auto px-4 py-2">
          {/* Grid de 3 columnas para Desktop pc */}
          ...
          <div className="md:hidden bg-white shadow-lg p-4 space-y-4 border-t border-gray-200">
            ...
            {isLoggedIn ? (
              <div className='flex flex-col gap-2'>
                ...
                <button onClick={handleLogout} className="px-4 py-2 rounded-lg bg-gray-200 text-gray-800 text-md font-medium hover:bg-gray-300 transition">
                  Salir
                </button>
              </div>
            ) : (
      ...
      <footer className="bg-purple-100 text-purple-800 p-4 text-center border-t border-purple-200">
